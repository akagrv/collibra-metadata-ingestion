...
def ingest_table(communityName, domainName, schemaList, tableList, session, parentCommunityName = None):
    ...
    for schemaName, tableName in zip(schemaList, tableList):
        ...
        asset_list.append((communityName, domainName, schemaName+'__'+tableName, 'Table', tableName, relations))
